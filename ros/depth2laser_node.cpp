...
void infoCallback(const sensor_msgs::CameraInfo::ConstPtr& info){
    //K matrix
    //================================================================================
    camerainfo.K = info->K;//把相机的K数组存到自己声明的K中
    ...
    //================================================================================
    ROS_INFO_STREAM("waif for camera tf " << c.base_frame_id << " - " << info->header.frame_id << " ...");
    ...
    ROS_INFO_STREAM("waif for laser tf " << c.base_frame_id << " - " << c.laser_frame_id << " ...");
